...
import { StyleSheet, View, TouchableOpacity, Image, Dimensions, Text, SafeAreaView, ScrollView, Alert} from 'react-native';
...
export default class Map extends Component {
  ...
  handlePress = () => {
    // pinId = nextId();
    // Alert.alert("se apretó el boton");
    // this.setState({
    //   markers: [
    //     ...this.state.markers,
    //     {
  ...
  render() {
    ...
    <View style={{ flex: 1 }}>
      ...
      onPress={this.onPress}>
        <Image 
        source={require('AwesomeProject/assets/arrow.png')}
